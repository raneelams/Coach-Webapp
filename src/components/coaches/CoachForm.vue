<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control" :class="{invalid: !lastName.isValid}">
      ...
      <input type="text" id="lastname" v-model.trim="lastName.val" @blur="clearValidity('lastName')"/> <!-- trim method to remove extra white spaces-->
    ...
    <div class="form-control" :class="{invalid: !rate.isValid}">
      ...
      <input type="text" id="rate" v-model.number="rate.val" @blur="clearValidity('rate')"/> <!-- number is a method to conver the value in to number-->
